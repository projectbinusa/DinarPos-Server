...
@Service
public class ExcelLaporanServiceWithCancel {
    public static final String TYPE = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
    static String[] HEADERsLAPORANSERVICEINCANCEL = {"NO", "TANDA TERIMA", "NO FAKTUR", "NAMA CUSTOMER", "ALAMAT", "NO TELP", "TEKNISI", "PRODUK", "KELUHAN", "PENERIMA", "TANGGAL MASUK", "TANGGAL JADI", "TANGGAL AMBIL", "BIAYA SPAREPART", "BIAYA SERVICE", "TOTAL"};
    ...
    public ByteArrayInputStream laporanServiceWithCancelToExcel(List<ServiceBarang> serviceBarangs) {
        try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            for (int col = 0; col < HEADERsLAPORANSERVICEINCANCEL.length; col++) {
                Cell cell = headerRow.createCell(col);
                cell.setCellValue(HEADERsLAPORANSERVICEINCANCEL[col]);
            ...
            for (ServiceBarang serviceBarang : serviceBarangs) {
                ...
                Cell cellAlamat = row.createCell(4);
                ...
                Cell cellCustomerTelp = row.createCell(5);
                ...
                Cell cellTanggalJadi = row.createCell(11);
                ...
                Cell cellTanggalAmbil = row.createCell(12);
                ...
                Cell cellBiayaSparepart = row.createCell(13);
                ...
                Cell cellBiayaService = row.createCell(14);
                ...
                Cell cellTotal = row.createCell(15);
