...
@Service
public class ExcelLaporanServiceWithTaken {
    public static final String TYPE = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
    static String[] HEADERsLAPORANSERVICEINPTAKEN = {"NO", "TANDA TERIMA", "NO FAKTUR", "STATUS", "NAMA CUSTOMER", "ALAMAT", "NO TELP", "TEKNISI", "PRODUK", "KELUHAN", "PENERIMA", "TANGGAL MASUK", "TANGGAL JADI", "TANGGAL AMBIL", "BIAYA SPAREPART", "BIAYA SERVICE", "TOTAL"};
    private static final String SHEET_NAME = "Laporan Service Taken Y";
    ...
    public ByteArrayInputStream laporanServiceWithTakenToExcel(List<ServiceBarang> serviceBarangs) {
        try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            for (int col = 0; col < HEADERsLAPORANSERVICEINPTAKEN.length; col++) {
                Cell cell = headerRow.createCell(col);
                cell.setCellValue(HEADERsLAPORANSERVICEINPTAKEN[col]);
            ...
            for (ServiceBarang serviceBarang : serviceBarangs) {
                ...
                cellStatus.setCellValue(serviceBarang.getStatusEnd());
